...
DEVELOPER = "@LUFFY_49"
CHANNEL_URL = "https://t.me/+NSeV2GNICZhiZjc9"
...
<div class="wrap">
<nav>
  <div class="brand">GhostBomber API</div>
  <div class="nav">
    <a href="/panel">Open Panel</a>
    <a class="pri" href="https://t.me/TheGhostBomber" target="_blank">Get Key</a>
  </div>
</nav>

<section class="hero">
  <div class="badge">{html_lib.escape(VERSION)} · LIVE</div>
  <h1>Premium Api<br/><span>SMS Gateway</span></h1>
  <p class="sub">Secure REST API with key access, instant queue, and live device pool. Clean · Fast · Reseller ready.</p>
  <div class="cta">
    <a class="p" href="https://t.me/Hackerwibes" target="_blank">DM {html_lib.escape(DEVELOPER)}</a>
    <a class="g" href="https://www.instagram.com/Hackerwibes" target="_blank">Instagram</a>
...
<footer class="footer">
  Developed by <a href="https://t.me/Hackerwibes" target="_blank">{html_lib.escape(DEVELOPER)}</a>
  · <a href="https://www.instagram.com/Hackerwibes" target="_blank">@Hackerwibes</a>
...
<title>Admin | TheGhostBomber</title>
...
<div class="foot">Dev <a href="https://t.me/Hackerwibes" target="_blank">{html_lib.escape(DEVELOPER)}</a>
 · <a href="https://www.instagram.com/Hackerwibes" target="_blank">@Hackerwibes</a></div>
</div></body></html>"""
...
<td class="muted">{html_lib.escape(str(a.get("details","")))}</td></tr>"""
    ...
    return f"""<!DOCTYPE html>
<html><head><meta charset="utf-8"/><meta name="viewport" content="width=device-width,initial-scale=1"/>
<title>TheGhostBomber Admin</title>
<link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@600;800&family=Rajdhani:wght@500;700&display=swap" rel="stylesheet"/>
<style>
...
<div class="split">
  ...
  <div class="card">
    ...
    <form method="post" action="/admin/apikey/create" style="margin-bottom:12px">
      ...
      <input name="custom_key" placeholder="Custom Key (e.g. The_Ghost_1)" required/>
      <div class="row">
...
<div class="glass-card" id="gate">
  ...
  <div class="powered">Powered by <a href="https://t.me/Hackerwibes" target="_blank">@Hackerwibes</a></div>
  
  <div class="footer-div">
    <div class="social-icons">
      <a href="https://www.instagram.com/Hackerwibes" target="_blank" class="social-link"><i class="fab fa-instagram"></i></a>
      <a href="https://t.me/Hackerwibes" target="_blank" class="social-link"><i class="fab fa-telegram"></i></a>
    </div>
